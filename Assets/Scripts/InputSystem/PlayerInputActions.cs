...
public partial class @PlayerInputActions: IInputActionCollection2, IDisposable
{
    ...
    private List<INinjaOnFootActions> m_NinjaOnFootActionsCallbackInterfaces = new List<INinjaOnFootActions>();
    ...
    public struct NinjaOnFootActions
    {
        ...
        public void AddCallbacks(INinjaOnFootActions instance)
        {
            if (instance == null || m_Wrapper.m_NinjaOnFootActionsCallbackInterfaces.Contains(instance)) return;
            m_Wrapper.m_NinjaOnFootActionsCallbackInterfaces.Add(instance);
        ...
        private void UnregisterCallbacks(INinjaOnFootActions instance)
        {
            @Jump.started -= instance.OnJump;
            @Jump.performed -= instance.OnJump;
            @Jump.canceled -= instance.OnJump;
        ...
        public void RemoveCallbacks(INinjaOnFootActions instance)
        {
            if (m_Wrapper.m_NinjaOnFootActionsCallbackInterfaces.Remove(instance))
                UnregisterCallbacks(instance);
        }

        public void SetCallbacks(INinjaOnFootActions instance)
        {
            foreach (var item in m_Wrapper.m_NinjaOnFootActionsCallbackInterfaces)
                UnregisterCallbacks(item);
            m_Wrapper.m_NinjaOnFootActionsCallbackInterfaces.Clear();
